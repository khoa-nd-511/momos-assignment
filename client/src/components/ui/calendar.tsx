  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        month_caption: "block text-center",
        caption_label: "text-sm font-medium",
        nav: "space-x-1 flex items-center",
        button_previous: cn(
          buttonVariants({ variant: "ghost" }),
          "absolute left-9 top-0 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        button_next: cn(
          buttonVariants({ variant: "ghost" }),
          "absolute right-9 top-0 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
